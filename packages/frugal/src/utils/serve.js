...
/** @type {import('./serve.js').nativeHandler} */
...
/**
 * @param {Response | import('./serve.js').EventStreamResponse} response
 * @returns {response is import('./serve.js').EventStreamResponse}
 */
