...
import { RestartableChildProcess } from "../../../src/utils/RestartableChildProcess.js";

test("unit/RestartableChildProcess: spawn a subprocess piping stdout", async () => {
	const childProcess = RestartableChildProcess.spawn(process.execPath, {
...
test("unit/RestartableChildProcess: restartable", async () => {
...
test("unit/RestartableChildProcess: flood stdio", async () => {
	const childProcess = RestartableChildProcess.spawn(process.execPath, {
