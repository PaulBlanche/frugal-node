...
test("unit/server/error: default 400 error page", async () => {
	...
	assert.deepEqual(Array.from(response.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"LA6EGN"' ]])
	assert.deepEqual(await response.text(), '<html lang="en" />\n<head>\n\t<meta charSet="utf-8" />\n\t<meta name="viewport" content="width=device-width, initial-scale=1" />\n\t<link rel="icon" type="image/svg+xml" href="/favicon.svg" />\n</head>\n<body>\n\t<style>\n    .frugal-error-wrapper {\n        position: absolute;\n        inset: 0;\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        font-family: "Sofia sans condensed", sans-serif;\n        flex-direction: column;\n    }\n    .frugal-error-wrapper h1 {\n        font-size: 10rem;\n        margin: 0;\n        font-weight: 200;\n    }\n    .frugal-error-wrapper h2 {\n        font-weight: 300;\n    }\n</style>\n<div class="frugal-error-wrapper">\n    <h1>400</h1>\n    <h2>Bad Request</h2>\n</div>\n</body>\n</html>');
});
...
test("unit/server/error: default 404 error page", async () => {
	...
	assert.notStrictEqual(response, nextResponse);
	assert.deepEqual(Array.from(response.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"1PTVS99"' ]])
...
test("unit/server/error: default 405 error page", async () => {
	...
	assert.notStrictEqual(response, nextResponse);
	assert.deepEqual(Array.from(response.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"2ENATF"' ]])
...
test("unit/server/error: default 500 error page", async () => {
	...
	assert.notStrictEqual(response, nextResponse);
	assert.deepEqual(Array.from(response.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"LMFZ35"' ]])
...
test("unit/server/error: default base error page", async () => {
	...
	assert.notStrictEqual(response, nextResponse);
	assert.deepEqual(Array.from(response.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"6J7P98"' ]])
...
test("unit/server/error: custom error page", async () => {
	...
	assert.deepEqual(Array.from(response400.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"LA6EGN"' ]])
	assert.deepEqual(await response400.text(), '<html lang="en" />\n<head>\n\t<meta charSet="utf-8" />\n\t<meta name="viewport" content="width=device-width, initial-scale=1" />\n\t<link rel="icon" type="image/svg+xml" href="/favicon.svg" />\n</head>\n<body>\n\t<style>\n    .frugal-error-wrapper {\n        position: absolute;\n        inset: 0;\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        font-family: "Sofia sans condensed", sans-serif;\n        flex-direction: column;\n    }\n    .frugal-error-wrapper h1 {\n        font-size: 10rem;\n        margin: 0;\n        font-weight: 200;\n    }\n    .frugal-error-wrapper h2 {\n        font-weight: 300;\n    }\n</style>\n<div class="frugal-error-wrapper">\n    <h1>400</h1>\n    <h2>Bad Request</h2>\n</div>\n</body>\n</html>');
	...
	assert.deepEqual(Array.from(response404.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"LZ0HWM"' ]])
	...
	assert.deepEqual(Array.from(response502.headers.entries()), [[ 'content-type', 'text/plain;charset=UTF-8' ], [ 'etag', 'W/"G6NY54"' ]])
