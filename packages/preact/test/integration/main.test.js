	...
	await test("inte/preact: embedData and useData error", async () => {
		await puppeteer.withPage(
			async ({ page }) => {
				...
				assert.equal(
					await page.content(),
					`<!DOCTYPE html><html><head><script data-priority="-2">window.__FRUGAL__ = {"pageData":{"embedData":false,"location":{"pathname":"/page2","search":""}}};</script><script async="" type="module" src="/js/page2-G7VOSJBR.js"></script><script data-priority="-1">window.__FRUGAL__.islands = window.__FRUGAL__.islands || { instances:{}, names:{}};window.__FRUGAL__.islands.instances["p0-0"] = { props: {"id":1,"date":new Date("1970-01-01T00:00:01.234Z"),"children":{"type":"frugal-slot"}}, name: "Client" };window.__FRUGAL__.islands.names["Client"] = window.__FRUGAL__.islands.names["Client"] || [];window.__FRUGAL__.islands.names["Client"].push("p0-0");</script></head><body><div><span>App</span><!--frugal-island:start:p0-0--><div>client 1 1234</div><p>wrap in DataProvider</p><!--frugal-slot:start:p0-0:children--><!--frugal-slot:end:p0-0:children--><!--frugal-island:end:p0-0--></div></body></html>`,
				);
			},
			{ browser },
		);
