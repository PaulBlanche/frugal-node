/** @import * as self from "./Head.js" */

import * as preact from "preact";
import * as hooks from "preact/hooks";
import { Effect } from "./Effect.js";

export const headManagerContext = /** @type {self.headManagerContext} */ (
	preact.createContext(undefined)
);

/** @type {self.HeadProvider} */
...
function reduceComponents(effects) {
	return (
		effects
			...
			.sort((a, b) => {
				if ("data-priority" in a.props && "data-priority" in b.props) {
					return a.props - b.props;
				}
				if ("data-priority" in a.props) {
					return a.props;
				}
				if ("data-priority" in b.props) {
					return -b.props;
				}
				return 0;
			})
